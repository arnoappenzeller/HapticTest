...
class ViewController: UITableViewController
{
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            case 0:
                cell.textLabel?.text = "Trigger impact feedback (light)"
            case 1:
                cell.textLabel?.text = "Trigger impact feedback (medium)"
            case 2:
                cell.textLabel?.text = "Trigger impact feedback (heavy)"
            default:
                break
            }
        case 1:
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        switch indexPath.section {
        case 0:
            let weight: UIImpactFeedbackStyle
            switch indexPath.row {
            case 0:
                weight = .light
            case 1:
            ...
            triggerImpactFeedback(weight: weight)
        case 1:
    ...
    //MARK: - haptic methods
    func triggerImpactFeedback(weight: UIImpactFeedbackStyle){
        let feedback = UIImpactFeedbackGenerator(style: weight)
